...
const Buttonfoldescanbtn = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "e4a2c235f5b447a69400f0da6559632b",
          isTable: false,
          from:"ButtonFolder Scan",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "foldescanbtn9632b") {
        handleClick();
      }
    });
  },[foldescanbtn9632b?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    if(scanData4){
      for(let i=0;i<scanData4.length;i++){
        imgData4.push(scanData4[i].CDNImageUrl);
      }
    setoverallgroup00e53((pre:any)=>({...pre,docviewer:imgData4}));
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {foldescanbtn9632b?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
          icon="MdFolderOpen"
...
export default Buttonfoldescanbtn
