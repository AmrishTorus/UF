 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "237db0137d744feea41a15d3f9074e6a",
          isTable: false,
          from:"ButtonCancel",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "cancelbtn74e6a") {
        handleClick();
      }
    });
  },[cancelbtn74e6a?.refresh,currentToken])
  ...
  return (
    <div
      ...
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="   !bg-red-100 !text-red-600 !rounded-md"
          onClick={handleClick}
          view='action'
          disabled= {cancelbtn74e6a?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
...
export default Buttoncancelbtn
