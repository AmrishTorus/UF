 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "7f3f0e67a4d447babee77c43bbb81d63",
          isTable: false,
          from:"ButtonDelete",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "deletebtn81d63") {
        handleClick();
      }
    });
  },[deletebtn81d63?.refresh,currentToken])
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {deletebtn81d63?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
...
export default Buttondeletebtn
