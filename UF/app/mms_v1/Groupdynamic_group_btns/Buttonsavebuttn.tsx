...
const Buttonsavebuttn = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "df39c0db027c407dbd4110c300d2c3e8",
          isTable: false,
          from:"ButtonSave",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "savebuttn2c3e8") {
        handleClick();
      }
    });
  },[savebuttn2c3e8?.refresh,currentToken])
  ...
  async function handleSavee8_1_1_1_2(){
    ...
    try{
      ...
      let tagetKey:string="CK:CT005:FNGK:AF:FNK:PF-PFD:CATK:V001:AFGK:MMS:AFK:mandate_scan_save:AFVK:v1|7bf1230b2af34cbd857d373cacca864a"
      let uf_getPFDetails:any={
        key: "CK:CT005:FNGK:AF:FNK:PF-PFD:CATK:V001:AFGK:MMS:AFK:mandate_scan_save:AFVK:v1|7bf1230b2af34cbd857d373cacca864a"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "df39c0db027c407dbd4110c300d2c3e8",
  "type": "button",
  "name": "savebuttn",
  "sequence": 1,
  "children": [
    {
      "id": "df39c0db027c407dbd4110c300d2c3e8.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1",
          ...
          "children": [
            ...
            {
              "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "saveHandler",
              ...
              "children": [
                {
                  "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "hasDataHandler",
                  ...
                  "children": [
                    {
                      "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.1",
                      "type": "responseNode",
                      "name": "success",
                      "sequence": "1.1.1.2.1.1",
                      "children": [
                        {
                          "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.1.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "infoMsg",
                    ...
                    {
                      "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2",
                      "type": "responseNode",
                      "name": "fail",
                      "sequence": "1.1.1.2.1.2",
                      "children": [
                        {
                          "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "infoMsg",
                          ...
                          "children": [
                            {
                              "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2.1.1",
                              "eventContext": "rise",
                              "value": "",
                              "type": "handlerNode",
                              "name": "clearHandler",
                            ...
                            {
                              "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2.1.2",
                              "eventContext": "riseListen",
                              "value": "",
                              "type": "handlerNode",
                              "name": "clearHandler",
                              ...
                              "children": [
                                {
                                  "id": "7dcbb77d1237433ab29b91ee87e3fb9d.1.1.1.2.1.2.1.2.1",
                                  "type": "group",
                            ...
                            {
                              "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2.1.3",
                              "eventContext": "riseListen",
                              "value": "",
                              "type": "handlerNode",
                              "name": "clearHandler",
                              ...
                              "children": [
                                {
                                  "id": "4ec956e4599e4a4ab60a0db92557f52e.1.1.1.2.1.2.1.3.1",
                                  "type": "group",
                            ...
                            {
                              "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.1.2.1.4",
                              "eventContext": "riseListen",
                              "value": "",
                              "type": "handlerNode",
                              "name": "clearHandler",
                              ...
                              "children": [
                                {
                                  "id": "7512ba7a87c2441a9c7e365031a00e53|3c1d94fae5d64e60b344a7b32ed4f7f9.1.1.1.2.1.2.1.4.1",
                                  "type": "documentviewer",
                ...
                {
                  "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "bindTran",
                  ...
                  "children": [
                    {
                      "id": "0cd3582385e945bd94ae4cf9864378bc.1.1.1.2.2.1",
                      "value": "",
                      "type": "screen",
                ...
                {
                  "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.5",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "hasDataHandler",
                  ...
                  "children": [
                    {
                      "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.5.1",
                      "type": "responseNode",
                      "name": "success",
                      "sequence": "1.1.1.2.5.1",
                      "children": [
                        {
                          "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.5.1.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "copyFormData",
                          "sequence": "1.1.1.2.5.1.1",
                          "children": [],
                          "hlr": {
                            "params": [
                              {
                    ...
                    {
                      "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.5.2",
                      "type": "responseNode",
                      "name": "fail",
                      "sequence": "1.1.1.2.5.2",
                      "children": [
                        {
                          "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.5.2.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "infoMsg",
                          "sequence": "1.1.1.2.5.2.1",
                          "children": [],
                          "hlr": {
                            "params": [
                              {
                ...
                {
                  "id": "df39c0db027c407dbd4110c300d2c3e8.1.1.1.2.6",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "bindTran",
                  ...
                  "children": [
                    {
                      "id": "bb11e327ece246e9ac30eb202011fd5c.1.1.1.2.6.1",
                      "value": "",
                      "type": "screen",
              ...
              "targetKey": [
                "CK:CT005:FNGK:AF:FNK:PF-PFD:CATK:V001:AFGK:MMS:AFK:mandate_scan_save:AFVK:v1|7bf1230b2af34cbd857d373cacca864a"
              ]
            }
          ],
          "hlr": {
  ...
  // saveHandler
    ...
    let reworkKeys:any[]=[];
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(dynamic_group_btns3c327?.upId){
          te_saveBody['upId']= dynamic_group_btns3c327?.upId;
        }
        ...
        if (dynamic_group_btns3c327Props.ssKey !== '' && dynamic_group_btns3c327Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamic_group_btns3c327Props.ssKey;
    ...
    //bindTran
    // For group or table
      setvaldtn_data_lst378bc(te_save.data?.data[0]||{})
      setvaldtn_data_lst378bcProps({...valdtn_data_lst378bcProps,presetValues:te_save.data?.data[0]||{}})
            // hasDataHandler
            if(commonSepareteDataFromTheObject("data[0]",te_save?.data)){
    ...
    // copyFormData
    if(te_save?.data){
      setdynamic_group_btns3c327((pre:any)=>({...pre,...te_save?.data}));
      savedData.current=te_save?.data;
              ...
              //infoMsg
      toast(' Validation Error Not found', 'success')
              }
    //bindTran
    // For group or table
      setdoc_data_lst1fd5c(te_save.data?.data[0]||{})
      setdoc_data_lst1fd5cProps({...doc_data_lst1fd5cProps,presetValues:te_save.data?.data[0]||{}})
    }
    catch(err:any)
    {
      savedData.current = {};
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {savebuttn2c3e8?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
          icon="MdOutlineSave"
...
export default Buttonsavebuttn
