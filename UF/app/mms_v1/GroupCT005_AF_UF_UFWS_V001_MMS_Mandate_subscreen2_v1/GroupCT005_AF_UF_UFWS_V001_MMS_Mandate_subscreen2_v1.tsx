...
import Groupmndate_common_info  from "../Groupmndate_common_info/Groupmndate_common_info";
...
const GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:V001:AFGK:MMS:AFK:Mms_Mandate_Info:AFVK:v1",componentId:"5e1cbfe05c4345af818774dffe7a54b9",from:"GroupCt005AfUfUfwsV001MmsMandateSubscreen2V1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("mndate_common_info")){
      setmndate_common_info3fb9d({...mndate_common_info3fb9d,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9Ref.current?.setSearchParams();
    ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9) && Object.keys(ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9)?.length>0)
      {
        setct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("mndate_common_info")  &&<Groupmndate_common_info  
...
export default GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1
