...
import GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1  from "../GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1/GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1";
...
const Groupmnssubgroup = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:V001:AFGK:MMS:AFK:Mms_Mandate_Info:AFVK:v1",componentId:"a38a4205de7749949d08f1d1ec73df12",from:"GroupMnssubgroup",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1")){
      setct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9({...ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1a54b9,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const mnssubgroup3df12Ref = useRef<any>(null);
  const handleClearSearch = () => {
    mnssubgroup3df12Ref.current?.setSearchParams();
    mnssubgroup3df12Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(mnssubgroup3df12) && Object.keys(mnssubgroup3df12)?.length>0)
      {
        setmnssubgroup3df12({})
      }
    }else 
      prevRefreshRef.current= true
  }, [mnssubgroup3df12Props?.refresh,token])
  ...
  return (
    ...
    >
        {(showFlag == "ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1") &&allowedComponent.includes("ct005_af_uf_ufws_v001_mms_mandate_subscreen2_v1")  &&<GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_subscreen2_v1  
...
export default Groupmnssubgroup
