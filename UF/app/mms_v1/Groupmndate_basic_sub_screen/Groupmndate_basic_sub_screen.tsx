...
import GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1  from "../GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1/GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1";
...
const Groupmndate_basic_sub_screen = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:V001:AFGK:MMS:AFK:Mms_Mandate_Info:AFVK:v1",componentId:"7d26436183544c5ea5b0ba2bbe2c9573",from:"GroupMndateBasicSubScreen",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("ct005_af_uf_ufws_v001_mms_mandate_subscreen_v1")){
      setct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764c({...ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764c,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const mndate_basic_sub_screenc9573Ref = useRef<any>(null);
  const handleClearSearch = () => {
    mndate_basic_sub_screenc9573Ref.current?.setSearchParams();
    mndate_basic_sub_screenc9573Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(mndate_basic_sub_screenc9573) && Object.keys(mndate_basic_sub_screenc9573)?.length>0)
      {
        setmndate_basic_sub_screenc9573({})
      }
    }else 
      prevRefreshRef.current= true
  }, [mndate_basic_sub_screenc9573Props?.refresh,token])
  ...
  return (
    ...
    >
        {(showFlag == "ct005_af_uf_ufws_v001_mms_mandate_subscreen_v1") &&allowedComponent.includes("ct005_af_uf_ufws_v001_mms_mandate_subscreen_v1")  &&<GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1  
...
export default Groupmndate_basic_sub_screen
