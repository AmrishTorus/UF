...
const Buttondelete = ({mainData,setRefetch,encryptionFlagCompData}:any) => {
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "f804e039c6be4ac797790514ffad70e2",
          isTable: false,
          from:"ButtonAction",
  ...
  const handleClick=async()=>{
    if(docdatalst620a8Props?.validation==true && docdatalst620a8Props?.required==true || docdatalst620a8Props?.required==true)
    {
...
>
      <Button 
        ...
        onClick={handleClick}
        view='action'
        disabled= {deleted70e2?.isDisabled ? true : false}
        pin='circle-circle'
