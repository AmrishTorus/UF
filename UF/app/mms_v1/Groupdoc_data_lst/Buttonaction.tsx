...
const Buttonaction = ({mainData,setRefetch,encryptionFlagCompData}:any) => {
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "3047822c11554ebb8048cfe5fee55349",
          isTable: false,
          from:"ButtonAction",
  ...
  const handleClick=async()=>{
    if(doc_data_lst1fd5cProps?.validation==true && doc_data_lst1fd5cProps?.required==true || doc_data_lst1fd5cProps?.required==true)
    {
...
>
      <Button 
        ...
        onClick={handleClick}
        view='action'
        disabled= {action55349?.isDisabled ? true : false}
        pin='circle-circle'
