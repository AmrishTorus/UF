...
import Groupsubgroup  from "../Groupsubgroup/Groupsubgroup";
...
const GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:V001:AFGK:MMS:AFK:Mms_Mandate_Info:AFVK:v1",componentId:"27052ede587f4be09e9cc3e8c802764c",from:"GroupCt005AfUfUfwsV001MmsMandateSubscreenV1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("subgroup")){
      setsubgroup7f52e({...subgroup7f52e,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764cRef = useRef<any>(null);
  const handleClearSearch = () => {
    ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764cRef.current?.setSearchParams();
    ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764cRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764c) && Object.keys(ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764c)?.length>0)
      {
        setct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764c({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct005_af_uf_ufws_v001_mms_mandate_subscreen_v12764cProps?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("subgroup")  &&<Groupsubgroup  
...
export default GroupCT005_AF_UF_UFWS_V001_MMS_Mandate_Subscreen_v1
