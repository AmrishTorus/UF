...
const Textglobal_bank = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[global_bank33cbf?.refresh])

  if (global_bank33cbf?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 5`,gridRow: `3 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="header-1"
