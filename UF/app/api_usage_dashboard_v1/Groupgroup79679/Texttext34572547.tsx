...
const Texttext34572547 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text3457254757f70?.refresh])

  if (text3457254757f70?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `8 / 25`,gridRow: `1 / 9`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-3"
...
export default Texttext34572547
