...
const Iconicon8698 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"56f0779d27dc48b69c22ce9fc508bff3",controlId:"7bde4f4c662f4adb8fa084f12b46b1a3",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon86986b1a3?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `2 / 7`,gridRow: `2 / 15`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className="text-gray-400 hover:text-gray-600"
      data="MdOutlinePersonOff"
      contentAlign={"center"}
    />
  </div>
  )
