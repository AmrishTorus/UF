...
import Groupapi_call_over_week_group  from "../Groupapi_call_over_week_group/Groupapi_call_over_week_group";
...
const GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",componentId:"4a57e63929c64f3d840dbec9a03ce1f3",from:"GroupCt009AfUfUfwsTob001Tob002ApiCallOverWeekV1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_call_over_week_group")){
      setapi_call_over_week_group03bb6({...api_call_over_week_group03bb6,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3Ref.current?.setSearchParams();
    ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3) && Object.keys(ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3)?.length>0)
      {
        setct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("api_call_over_week_group")  &&<Groupapi_call_over_week_group  
...
export default GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1
