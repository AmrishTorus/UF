...
import Groupapi_call_over_hour_group  from "../Groupapi_call_over_hour_group/Groupapi_call_over_hour_group";
...
const GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",componentId:"4fa4ea98864b4f3498fb1019463e9bb7",from:"GroupCt009AfUfUfwsTob001Tob002ApiCallOverHourV1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_call_over_hour_group")){
      setapi_call_over_hour_group12590({...api_call_over_hour_group12590,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7Ref.current?.setSearchParams();
    ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7) && Object.keys(ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7)?.length>0)
      {
        setct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("api_call_over_hour_group")  &&<Groupapi_call_over_hour_group  
...
export default GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1
