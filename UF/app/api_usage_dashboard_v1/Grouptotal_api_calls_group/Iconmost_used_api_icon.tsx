...
const Iconmost_used_api_icon = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"6f9c80070d3f414787075e5de4fd4dee",controlId:"317cba85fc294a9598fe495b1726560d",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (most_used_api_icon6560d?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 7`,gridRow: `5 / 18`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
...
export default Iconmost_used_api_icon
