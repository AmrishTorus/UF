  ...
  const handleMapperDetails=async()=>{
    try{
      ...
      '/UF/Orchestration',
      {
        ...
        componentId: "6bb3bf72930743c8b2a1cb7bd4fd1676",
        controlId: "272a445f662a44eea72f80f52a1cc886",
        isTable: false,
    ...
    setapi_call_over_month_groupd1676((pre:any)=>({...pre,name:dfd_mongo_linechart_dfd_v1Props[0]?.name}))
  }
...
},[api_call_over_month_linechartcc886?.refresh])
...
useEffect(() => {
  ...
  if (api_call_over_month_linechartcc886?.isHidden) {
    return <></>
  }
  return (
    <div
