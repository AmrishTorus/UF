...
const Textapi_call_hours = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[api_call_hours6d062?.refresh])

  if (api_call_hours6d062?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 17`,gridRow: `1 / 11`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-3"
  color="primary"
>
      {keyset("API Calls Over Frequencies")}
</Text>
  </div>
  )
}

export default Textapi_call_hours
