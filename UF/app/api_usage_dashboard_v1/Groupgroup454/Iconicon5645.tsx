...
const Iconicon5645 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"98c73da3ec924b46a87aa54c7119ff98",controlId:"acbf8b1cee9343d9a5f6538efc44d73c",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon56454d73c?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `2 / 7`,gridRow: `3 / 18`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
