...
const Textconsent_lifecycles = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[consent_lifecycles11691?.refresh])

  if (consent_lifecycles11691?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `1 / 11`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="font-bold"
  variant="subheader-3"
  color="primary"
>
      {keyset("Consent Lifecycle Summary")}
</Text>
  </div>
  )
}

export default Textconsent_lifecycles
