...
const Icontot_req_icon = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"338a929827b441b58a690143f2cdf5e7",controlId:"6045e75f4c4f4834b39e147c6a31fa8f",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (tot_req_icon1fa8f?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 7`,gridRow: `4 / 18`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className="!text-white"
      data="MdChromeReaderMode"
      contentAlign={"center"}
    />
  </div>
  )
...
export default Icontot_req_icon
