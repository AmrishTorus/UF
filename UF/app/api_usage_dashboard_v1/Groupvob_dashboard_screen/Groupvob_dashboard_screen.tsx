...
import Groupapi_usage_group  from "../Groupapi_usage_group/Groupapi_usage_group";
...
import Grouptotal_api_calls_group  from "../Grouptotal_api_calls_group/Grouptotal_api_calls_group";
...
import Grouptotal_used_api_group  from "../Grouptotal_used_api_group/Grouptotal_used_api_group";
import Grouplist_of_register_tpp_group  from "../Grouplist_of_register_tpp_group/Grouplist_of_register_tpp_group";
import Groupapi_repo_table  from "../Groupapi_repo_table/Groupapi_repo_table";
import Groupgroup123  from "../Groupgroup123/Groupgroup123";
...
const Groupvob_dashboard_screen = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",componentId:"b659f0676d0243baa1258468e019ce49",from:"GroupVobDashboardScreen",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_usage_group")){
      setapi_usage_group868b4({...api_usage_group868b4,isDisabled:true});
    }
    ...
    if(orchestrationData?.data?.readableControls.includes("total_api_calls_group")){
      settotal_api_calls_groupd4dee({...total_api_calls_groupd4dee,isDisabled:true});
    }
    ...
    if(orchestrationData?.data?.readableControls.includes("total_used_api_group")){
      settotal_used_api_groupcd37d({...total_used_api_groupcd37d,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("list_of_register_tpp_group")){
      setlist_of_register_tpp_groupbe9d5({...list_of_register_tpp_groupbe9d5,isDisabled:true});
    }
    ...
    if(orchestrationData?.data?.readableControls.includes("group123")){
      setgroup1233a04c({...group1233a04c,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  return (
    ...
    >
        {allowedComponent.includes("api_usage_group")  &&<Groupapi_usage_group  
        ...
        {allowedComponent.includes("active_group")  &&<Groupactive_group  
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("total_api_calls_group")  &&<Grouptotal_api_calls_group  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
        ...
        {allowedComponent.includes("line_chart_group")  &&<Groupline_chart_group  
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("total_used_api_group")  &&<Grouptotal_used_api_group  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("list_of_register_tpp_group")  &&<Grouplist_of_register_tpp_group  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
        ...
        {allowedComponent.includes("api_repo_table")  &&<Groupapi_repo_table  
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("group123")  &&<Groupgroup123  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
