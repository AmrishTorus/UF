...
export default function LineChartsapi_call_over_hour_linechart({ 
  ...
  const handleMapperDetails=async()=>{
    try{
      ...
      '/UF/Orchestration',
      {
        ...
        componentId: "4d87575ab35747028e3c1704e5612590",
        controlId: "8a2389ccdc3a4226ad722323d0c38cfd",
        isTable: false,
    ...
    setapi_call_over_hour_group12590((pre:any)=>({...pre,name:dfd_mongo_linechart_dfd_v1Props[0]?.name}))
  }
...
},[api_call_over_hour_linechart38cfd?.refresh])
...
useEffect(() => {
  ...
  if (api_call_over_hour_linechart38cfd?.isHidden) {
    return <></>
  }
  return (
    <div
