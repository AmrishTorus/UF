...
import GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1  from "../GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1/GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1";
import GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Month_v1  from "../GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Month_v1/GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Month_v1";
import GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1  from "../GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1/GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1";
...
const Groupapi_call_over_frequency_subscreen = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",componentId:"5d1afd4ca36c45c69e76191eb74b8acc",from:"GroupApiCallOverFrequencySubscreen",accessProfile:accessProfile},{
    headers: {
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    let schemaFlag:any = evaluateDecisionTable(orchestrationData?.data?.rule.nodes,{},{...decodedTokenObj,...line_chart_groupadc5c});
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1")){
      setct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7({...ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1e9bb7,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_month_v1")){
      setct009_af_uf_ufws_tob001_tob002_api_call_over_month_v1bb789({...ct009_af_uf_ufws_tob001_tob002_api_call_over_month_v1bb789,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1")){
      setct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3({...ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1ce1f3,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const api_call_over_frequency_subscreenb8accRef = useRef<any>(null);
  const handleClearSearch = () => {
    api_call_over_frequency_subscreenb8accRef.current?.setSearchParams();
    api_call_over_frequency_subscreenb8accRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(api_call_over_frequency_subscreenb8acc) && Object.keys(api_call_over_frequency_subscreenb8acc)?.length>0)
      {
        setapi_call_over_frequency_subscreenb8acc({})
      }
    }else 
      prevRefreshRef.current= true
  }, [api_call_over_frequency_subscreenb8accProps?.refresh,token,line_chart_groupadc5c[uoMapperData["3afc9777e24c4b56851941fa42a5f803"]["source"]]])
  ...
  return (
    ...
    >
        {(showFlag == "ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1") &&allowedComponent.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_hour_v1")  &&<GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Hour_v1  
        ...
        {(showFlag == "ct009_af_uf_ufws_tob001_tob002_api_call_over_month_v1") &&allowedComponent.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_month_v1")  &&<GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Month_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {(showFlag == "ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1") &&allowedComponent.includes("ct009_af_uf_ufws_tob001_tob002_api_call_over_week_v1")  &&<GroupCT009_AF_UF_UFWS_TOB001_TOB002_API_Call_Over_Week_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
...
export default Groupapi_call_over_frequency_subscreen
