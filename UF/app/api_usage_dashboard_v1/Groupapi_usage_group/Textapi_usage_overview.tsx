...
const Textapi_usage_overview = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[api_usage_overviewecc9e?.refresh])

  if (api_usage_overviewecc9e?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `2 / 12`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="font-bold"
  variant="header-2"
  color="primary"
>
      {keyset("API Usage Overview")}
</Text>
  </div>
  )
}

export default Textapi_usage_overview
