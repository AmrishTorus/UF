...
const Textget_accounts_text = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[get_accounts_textded93?.refresh])

  if (get_accounts_textded93?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `12 / 21`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white "
  variant="subheader-1"
...
export default Textget_accounts_text
