...
const Textget_direct_debits_text = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[get_direct_debits_text067ca?.refresh])

  if (get_direct_debits_text067ca?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `48 / 60`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white"
  variant="subheader-1"
  color="primary"
>
      {keyset("Get Direct Debits")}
</Text>
  </div>
  )
}

export default Textget_direct_debits_text
