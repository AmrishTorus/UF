...
const Texttotal_used_api_text = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_used_api_text0681a?.refresh])

  if (total_used_api_text0681a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `1 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  ...
  color="primary"
>
      {keyset("Frequently Used APIs")}
</Text>
  </div>
  )
}

export default Texttotal_used_api_text
