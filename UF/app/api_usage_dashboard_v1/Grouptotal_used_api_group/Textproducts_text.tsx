...
const Textproducts_text = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[products_textc39eb?.refresh])

  if (products_textc39eb?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `62 / 72`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white "
  variant="subheader-1"
...
export default Textproducts_text
