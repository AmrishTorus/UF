...
const Iconicon234234 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"1d3a3c21edab4f3a88dd5a1631d622ab",controlId:"83e2aee542b04bd6af3f78e95a0e2c9a",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon234234e2c9a?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `2 / 7`,gridRow: `3 / 16`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className="text-red-500 hover:text-red-700"
      data="MdOutlineDangerous"
      contentAlign={"center"}
    />
  </div>
  )
