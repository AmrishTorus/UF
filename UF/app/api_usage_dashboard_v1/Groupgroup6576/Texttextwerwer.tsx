...
const Texttextwerwer = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[textwerweraf6e8?.refresh])

  if (textwerweraf6e8?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `8 / 18`,gridRow: `8 / 16`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
