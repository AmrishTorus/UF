...
const Texttextwrwer = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[textwrwer0e4e1?.refresh])

  if (textwrwer0e4e1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `8 / 18`,gridRow: `1 / 8`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-3"
