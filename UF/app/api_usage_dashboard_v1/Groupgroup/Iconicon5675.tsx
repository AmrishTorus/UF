...
const Iconicon5675 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT009:FNGK:AF:FNK:UF-UFW:CATK:TOB001:AFGK:TOB002:AFK:VOB_Dashboard_Design:AFVK:v1",  componentId:"ed35f907cd59456a97cdbdca7d1657d5",controlId:"8d91521a92fe45538149804bec0ee8ba",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
...
return (
  <div 
    style={{gridColumn: `2 / 7`,gridRow: `3 / 17`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
