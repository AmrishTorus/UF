...
import { Mms_Core_Banking_ApiController } from "./Mms_Core_Banking_Api.controller";
...
@Module({
    imports: [TeModule],
    controllers: [Mms_Core_Banking_ApiController],
...
export class Mms_Core_Banking_ApiModule {}
